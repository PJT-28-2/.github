...
애월은 의료비, 보험, 정기결제, 공동 양육비처럼 흩어져 있는 반려동물 관련 지출을 한곳에서 관리하도록 돕습니다. 지갑 충전과 QR 결제부터 지출 분석, 보험 청구 보조까지 보호자의 반복적인 금융·행정 업무를 간단하게 만드는 것을 목표로 합니다.
...
| 공동 양육 | 보호자를 초대해 권한을 나누고 육아일기와 활동 기록을 공유합니다. |
